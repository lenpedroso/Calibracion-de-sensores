# Peromite unir todos los parametros de los errores (MGE, SDMGE,MB,SD-MB) en una sola tabla
# Se baso en (https://r-coder.com/factor-en-r/) para construir el codigo
# Se empleo bind_rows para mantener en formato largo el df y unir filas (https://r-coder.com/rbind-cbind-en-r/)
