...
# Se tomo de base el repositorio de la profesora Sara Acevedo para transformar
...
# # Hacer una columna long para agregar los datos SINCA en la categoría sensores (Analisis temporal) --------
